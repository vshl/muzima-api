...
public class DefaultResource {
    ...
    private static final String[] configurations = new String[]{
            ...
            "# Resource\n" +
                    ...
                    "node.root=$['results']\n" +
                    "resource.object=com.muzima.api.model.Member\n" +
                    "algorithm.class=com.muzima.api.model.algorithm.MemberAlgorithm\n" +
                    "resolver.class=com.muzima.api.model.resolver.MemberCohortResolver\n" +
                    "\n" +
                    "# Searchable Fields\n" +
